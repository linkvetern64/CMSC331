...
if(isset($_POST['continue']))
{
   ...
   {
      $error = true;
      $error_msg = "Please select an appointment to reschedule.";
   }
   else
   {
...
<body>
    <div class = "fixed">
      <div class="transbox">
        <div class = "header">
	    <h2>Reschedule Advising Appointment</h2>
    	...
    	<div id="advisorBox">
		    <form action="?" name="cancel Appointment" id="cancel Appointment" method="POST">
                <div class="student_info">
                    <fieldset>
                        <div class="center"><div class="legendFont">Which appointment would you like to reschedule?</div></div>
                        <br>
                        <table>
							...
							<div id="radio">
								...
								<?php while($row = mysql_fetch_array($result)) {
									...
									<input type="radio" name="tags[]" value="<?php echo $counter; ?>" />
