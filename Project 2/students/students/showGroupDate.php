...
// 
// showGroupDate.php: - the user chose to make a group appointment
...
//
//		   after the choice has been made and click continue	=> redirects to showGroupTime.php
...
include("headersFooters/showGroupDateHeader.php");
